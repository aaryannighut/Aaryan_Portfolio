...
const JavaIcon = () => (
  <svg viewBox="0 0 128 128" className="w-[20px] h-[20px] md:w-[41.8px] md:h-[41.8px]">
...
const NodeIcon = () => (
  <svg viewBox="0 0 24 24" className="w-[20px] h-[20px] md:w-[41.8px] md:h-[41.8px] text-[#339933] fill-current">
    <title>Node.js</title>
...
const SqlIcon = () => (
  <svg viewBox="0 0 24 24" className="w-[20px] h-[20px] md:w-[41.8px] md:h-[41.8px] text-gray-400" fill="none" stroke="currentColor" strokeWidth="1.5">
...
const ReactIcon = () => (
  <svg viewBox="0 0 128 128" className="w-[20px] h-[20px] md:w-[41.8px] md:h-[41.8px] text-[#00D8FF] animate-[spin_15s_linear_infinite]">
    <g fill="currentColor">
...
export default function Hero() {
  ...
  return (
    <section
      ref={containerRef}
      id="hero"
      className="relative h-screen h-[100dvh] min-h-[600px] sm:min-h-[650px] lg:min-h-[720px] flex items-center justify-start bg-[#0A0A0A] overflow-hidden py-4 sm:py-8 lg:py-0"
    >
      ...
      <div className="absolute inset-0 w-full h-full z-0 select-none pointer-events-none">
        ...
        <img
          ...
          className="absolute w-[123%] sm:w-[109%] lg:w-full h-[95%] md:h-[103%] lg:h-[100.5%] object-cover object-[82%_center] lg:object-contain lg:object-[66%_center] scale-[0.995] translate-x-[14%] sm:translate-x-[4%] lg:translate-x-0"
          style={{
            top: "-2%",
            left: "-0.5%",
      ...
      <div className="max-w-7xl w-full mx-auto pl-3.5 pr-3 md:px-12 lg:px-16 z-10 relative grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-center h-full pt-16 pb-6 md:pt-20 md:pb-8 lg:pt-20 lg:pb-8">
        <div
          className="lg:col-span-7 flex flex-col justify-center text-left space-y-6 md:space-y-5 lg:space-y-6 select-none mt-4 lg:mt-0 max-h-full"
        ...
        >
          ...
          <motion.div
            ...
            className="glass-card w-full max-w-[310px] md:max-w-none py-1.5 md:py-3 px-2 md:px-4 rounded-lg md:rounded-xl border border-white/5 bg-[#0C0C0C]/85 shadow-[0_15px_35px_rgba(0,0,0,0.5)] flex items-center justify-between text-left gap-1 md:gap-4"
          >
            {/* Metric 1 */}
            <div className="flex-1 flex flex-col gap-0.5 items-start pl-0.5 md:pl-2">
              ...
              <span className="text-[6.5px] md:text-[9px] text-gray-500 font-mono uppercase tracking-[0.05em] leading-none" style={{ wordSpacing: "0.06em" }}>
                <span className="inline md:hidden">Wins</span>
                <span className="hidden md:inline">Hackathon Win</span>
              </span>
            </div>
            ...
            <div className="flex-1 flex flex-col gap-0.5 items-start pl-0.5 md:pl-2">
              ...
              <span className="text-[6.5px] md:text-[9px] text-gray-500 font-mono uppercase tracking-[0.05em] leading-none" style={{ wordSpacing: "0.06em" }}>
                ...
                <span className="hidden md:inline">Projects Built</span>
              </span>
            </div>
            <div className="w-[1px] h-3 md:h-6 bg-white/10" />
            ...
            <div className="flex-1 flex flex-col gap-0.5 items-start pl-0.5 md:pl-2">
              ...
              <span className="text-[6.5px] md:text-[9px] text-gray-500 font-mono uppercase tracking-[0.05em] leading-none" style={{ wordSpacing: "0.06em" }}>
                <span className="inline md:hidden">Focus</span>
                <span className="hidden md:inline">Enthusiast</span>
              </span>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="flex items-center gap-2 mt-1 sm:mt-2 pl-1 select-none"
          >
            <span className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse shadow-[0_0_8px_rgba(16,185,129,0.6)]" />
            <span className="font-mono text-[8.5px] md:text-[11px] uppercase tracking-[0.18em] md:tracking-[0.34em] text-gray-400 font-bold [word-spacing:0.12em] md:[word-spacing:0.28em]">
