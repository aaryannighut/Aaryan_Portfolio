...
const JavaIcon = () => (
  <svg viewBox="0 0 128 128" className="w-[20px] h-[20px] md:w-[41.8px] md:h-[41.8px] lg:w-[39.3px] lg:h-[39.3px]">
...
const NodeIcon = () => (
  <svg viewBox="0 0 24 24" className="w-[20px] h-[20px] md:w-[41.8px] md:h-[41.8px] lg:w-[39.3px] lg:h-[39.3px] text-[#339933] fill-current">
    <title>Node.js</title>
...
const SqlIcon = () => (
  <svg viewBox="0 0 24 24" className="w-[20px] h-[20px] md:w-[41.8px] md:h-[41.8px] lg:w-[39.3px] lg:h-[39.3px] text-gray-400" fill="none" stroke="currentColor" strokeWidth="1.5">
...
const ReactIcon = () => (
  <svg viewBox="0 0 128 128" className="w-[20px] h-[20px] md:w-[41.8px] md:h-[41.8px] lg:w-[39.3px] lg:h-[39.3px] text-[#00D8FF] animate-[spin_15s_linear_infinite]">
    <g fill="currentColor">
    ...
    >
      ...
      <div className="absolute inset-0 w-full h-full z-0 select-none pointer-events-none">
        ...
        <img
          ...
          className="absolute w-[123%] sm:w-[109%] lg:w-full h-[95%] md:h-[103%] lg:h-[102.5%] object-cover object-[82%_center] lg:object-contain lg:object-[66%_center] scale-[0.995] translate-x-[14%] sm:translate-x-[4%] lg:translate-x-0"
          style={{
            top: "-2%",
            left: "-0.5%",
